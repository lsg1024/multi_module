...
-- 데이터 중복 방지 (ON CONFLICT 사용)
INSERT INTO CLASSIFICATION (CLASSIFICATION_NAME, CLASSIFICATION_NOTE, DEFAULT_ID)
VALUES ('', '', TRUE) ON CONFLICT (CLASSIFICATION_NAME) DO NOTHING;
...
-- 데이터 중복 방지
INSERT INTO MATERIAL (MATERIAL_NAME, MATERIAL_GOLD_PURITY_PERCENT, DEFAULT_ID) VALUES ('', 0, TRUE) ON CONFLICT (MATERIAL_NAME) DO NOTHING;
INSERT INTO MATERIAL (MATERIAL_NAME, MATERIAL_GOLD_PURITY_PERCENT, DEFAULT_ID) VALUES ('14K', 58.50, TRUE) ON CONFLICT (MATERIAL_NAME) DO NOTHING;
INSERT INTO MATERIAL (MATERIAL_NAME, MATERIAL_GOLD_PURITY_PERCENT, DEFAULT_ID) VALUES ('18K', 75.00, TRUE) ON CONFLICT (MATERIAL_NAME) DO NOTHING;
INSERT INTO MATERIAL (MATERIAL_NAME, MATERIAL_GOLD_PURITY_PERCENT, DEFAULT_ID) VALUES ('24K', 100.00, TRUE) ON CONFLICT (MATERIAL_NAME) DO NOTHING;
...
INSERT INTO SET_TYPE (SET_TYPE_NAME, SET_TYPE_NOTE, DEFAULT_ID)
VALUES ('', '', TRUE) ON CONFLICT (SET_TYPE_NAME) DO NOTHING;
...
INSERT INTO COLOR (COLOR_NAME, COLOR_NOTE, DEFAULT_ID)
VALUES ('', '', TRUE) ON CONFLICT (COLOR_NAME) DO NOTHING;
...
INSERT INTO STONE_SHAPE (STONE_SHAPE_NAME, STONE_SHAPE_NOTE)
VALUES ('', '') ON CONFLICT (STONE_SHAPE_NAME) DO NOTHING;
...
INSERT INTO STONE_TYPE (STONE_TYPE_NAME, STONE_TYPE_NOTE)
VALUES ('', '')
    ON CONFLICT (STONE_TYPE_NAME) DO NOTHING;
...
-- 8. STONE_WORK_GRADE_POLICY TABLE
...
CREATE TABLE IF NOT EXISTS PRODUCT (
    ...
    PRODUCT_RELATED_NUMBER VARCHAR(255), -- V2에서 추가된 컬럼
...
ALTER TABLE PRODUCT ADD COLUMN IF NOT EXISTS PRODUCT_RELATED_NUMBER VARCHAR(255);
...
-- 12. PRODUCT_WORK_GRADE_POLICY_GROUP TABLE
...
-- 13. PRODUCT_WORK_GRADE_POLICY TABLE
...
INSERT INTO ASSISTANCE_STONE (ASSISTANCE_STONE_NAME, ASSISTANCE_STONE_NOTE) VALUES ('입없음', '') ON CONFLICT (ASSISTANCE_STONE_NAME) DO NOTHING;
INSERT INTO ASSISTANCE_STONE (ASSISTANCE_STONE_NAME, ASSISTANCE_STONE_NOTE) VALUES ('입예정', '') ON CONFLICT (ASSISTANCE_STONE_NAME) DO NOTHING;
INSERT INTO ASSISTANCE_STONE (ASSISTANCE_STONE_NAME, ASSISTANCE_STONE_NOTE) VALUES ('랩다이아', '') ON CONFLICT (ASSISTANCE_STONE_NAME) DO NOTHING;
INSERT INTO ASSISTANCE_STONE (ASSISTANCE_STONE_NAME, ASSISTANCE_STONE_NOTE) VALUES ('모이사', '') ON CONFLICT (ASSISTANCE_STONE_NAME) DO NOTHING;