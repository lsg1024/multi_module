...
ALTER TABLE STOCK ADD COLUMN IF NOT EXISTS create_date TIMESTAMP;
ALTER TABLE STOCK ADD COLUMN IF NOT EXISTS last_modified_date TIMESTAMP;
...
CREATE TABLE IF NOT EXISTS SALE (
    ...
    ACCOUNT_HARRY DECIMAL(10, 2),
    ACCOUNT_GRADE VARCHAR(255),
    ACCOUNT_GOLD_PRICE INTEGER,
...
ALTER TABLE SALE ADD COLUMN IF NOT EXISTS ACCOUNT_GOLD_PRICE INTEGER;
...
CREATE TABLE IF NOT EXISTS SALE_PAYMENT (
    ...
    CONSTRAINT UK_PAYMENT_IDEMP UNIQUE (EVENT_ID)
);

CREATE INDEX IF NOT EXISTS IX_PAYMENT_SALE ON SALE_PAYMENT (SALE_ID, create_date);

CREATE TABLE IF NOT EXISTS OUT_BOX_EVENT (
    ID BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    TOPIC VARCHAR(255),
