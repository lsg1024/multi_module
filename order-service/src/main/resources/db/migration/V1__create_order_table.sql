...
CREATE TABLE IF NOT EXISTS STOCK (
    ...
    GOLD_WEIGHT DECIMAL(10, 3),
    STONE_WEIGHT DECIMAL(10, 3),
    STOCK_CREATE_AT TIMESTAMPTZ NOT NULL,
...
CREATE INDEX IF NOT EXISTS IX_STOCK_CREATE_AT ON STOCK (STOCK_CREATE_AT);
...
CREATE INDEX IF NOT EXISTS IX_PAYMENT_SALE ON SALE_PAYMENT (SALE_ID, CREATED_AT);